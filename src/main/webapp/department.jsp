			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<ul class="top-bar-info list-inline-item pl-0 mb-0">
						<li class="list-inline-item"><a href="mailto:support@gmail.com"><i class="icofont-support-faq mr-2"></i>Stalliontech999@gmail.com</a></li>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>Let's know moreel the stress of pain the troubles fall upon our admirers. And when he inquires of his ancestors.</p>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					...
					<div class="content">
						...
						<p class="mb-4">There are often no symptoms present, all enduring a pain.</p>
		...
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<p>Times of sorrow for pleasures for true pleasure, it's easy for them to become blinded by the truth.</p>

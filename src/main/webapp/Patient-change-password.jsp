...
<% 
	...
	if(session.getAttribute("data")!=null){
		p  = (Stallion)session.getAttribute("data");
	}
	else{
               ...
               <form id="#" class="appoinment-form" method="post" action="PController" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6">
                            <div class="form-group">
                                <input name="email" id="email" type="hidden" class="form-control" value="<%=p.getEmail()%>">
                            </div>
                        </div>
                         <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="text-center">
                       		 <input class="btn btn-main btn-round-full" name="actions" type="submit" value="Change Password"></input>
                  	    </div>
                   	    ${msg }     
               </div>
            </form>

		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					...
					<p>The pain itself is a lot of fun, it's enhanced. With accepted team of admirers, seek even the most worthy. they are all great and welcomes all these symptoms, from which there is some distinction between them,anyone here, so we can. The pain itself is a lot of pain And this will occur in other ways, by reason of the desire to be accepted by the pains, to be countered by the right of things here, but at least not by itself, but the pleasure of the body they do not know at the time. Season.</p>
	...
	<div class="container">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block mb-4">
						...
						<h4 class="mt-2"><a href="tel:9426552661">Stalliontech999@gmail.com</a></h4>
					</div>
		...
		<div class="footer-btm py-4 mt-5">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6">
					<div class="copyright">
						&copy; Copyright Reserved to <span class="text-color">Gujarat</span> by <a href="https://themefisher.com/" target="_blank">Stalliontech</a>
					</div>
				</div>

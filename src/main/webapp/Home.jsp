			   ...
			   <li class="nav-item"><a class="nav-link" href="about.jsp">About</a></li>
			    ...
			    <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						<li><a class="dropdown-item" href="Patient-Registration.jsp">Patient-Registration</a></li>
						<li><a class="dropdown-item" href="Patient-Login.jsp">Patient-Login</a></li>
					</ul>
			  	</li>
			  	...
			  	<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li><a class="dropdown-item" href="Doctor-Registration.jsp">Doctors-Registration</a></li>
						<li><a class="dropdown-item" href="Doctor-Login.jsp">Doctor-Login</a></li>
					</ul>
			  	</li>

        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    ...
                    <p class="mb-5">The hardships of a happy exercise may result in them and similarly, is there any reason to welcome the resilience to carry messages greater?</p>
                </div>
            </div>
        </div>
        <div class="row">
	...
	<div class="container">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block mb-4">
						...
						<h4 class="mt-2"><a href="tel:9879161318">Stalliontech999@gmail.com</a></h4>
					</div>
		...
		<div class="footer-btm py-4 mt-5">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6">
					<div class="copyright">
						&copy; Copyright Reserved to <span class="text-color">Doctor</span> by <a href="https://themefisher.com/" target="_blank">Stalliontech</a>
					</div>
				</div>

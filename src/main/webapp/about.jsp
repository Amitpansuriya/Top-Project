...
<section class="section about-page">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				<p>The pain itself is a lot of pain They occur because of other hardships. Life is pain and responsibility! They often do nothing but look at the consequences that occur, what they are, who should be blamed for the most worthy, free-choice
				.</p>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					...
					<p>Pleasure will open up that we can best be avoided, nothing that accuses us .</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
	...
	<div class="container">
		...
		<div class="footer-btm py-4 mt-5">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6">
					<div class="copyright">
						&copy; Copyright Reserved to <span class="text-color">Doctor</span> by <a href="https://themefisher.com/" target="_blank">Staliontech</a>
					</div>
				</div>

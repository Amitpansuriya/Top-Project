			   ...
			   <li class="nav-item"><a class="nav-link" href="">About</a></li>
			    <li class="nav-item"><a class="nav-link" href="">Services</a></li>
			  	<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="doctor.html" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><%=p.getName() %> <i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li><a class="dropdown-item" href="Patient-Home.jsp">Home</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">Confirm Appoinment</h1>
				...
				<div class="col-md-12">
					...
					<form id="#" class="appoinment-form" method="post" action="AController" >
						<table class="table table-striped">
						  ...
						  <% int id = p.getId(); %>
						  <%List <Appointment> list = AppointmentDao.AllConfirmappointmentlistPatient(id); %>
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><%=l.getStatus()%></td>
						      	...
						      	<td>
						      			...
						      			<!-- <input type ="submit" name="action" value="Cancel" class="btn-sm btn-main btn-round-full"> -->
